...
int main() {
    ...
    Raytracer::render3(raiz3, "union", 1600, 1600, 20);
    ...
    Raytracer::render3(raiz4, "intersection", 1600, 1600, 20);
    ...
    Raytracer::render3(testeSsfere, "testeSsfere", 1600, 1600, 20);
    ...
    Raytracer::render3(raiz5, "difference", 1600, 1600, 20);
