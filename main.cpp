...
int main() {
    ...
    Raytracer::render3(raiz3, "union", 800, 800, 20);
    ...
    Raytracer::render3(raiz4, "intersection", 800, 800, 20);
    ...
    Raytracer::render3(testeSsfere, "testeSsfere", 800, 800, 20);
    ...
    Raytracer::render3(raiz5, "difference", 800, 800, 20);
